...
object TotImageProvider {
    ...
    private val directMap: Map<String, Any> = mapOf(
        ...
        "tot:tot_polish_cuisine_traditional:2:a" to R.drawable.pl_03_golabki,
        "tot:tot_polish_cuisine_traditional:2:b" to R.drawable.pl_03_kotlet_schabowy,
        "tot:tot_polish_cuisine_traditional:3:a" to R.drawable.pl_04_placki_ziemniaczane,
        "tot:tot_polish_cuisine_traditional:3:b" to R.drawable.pl_04_kopytka,
        "tot:tot_polish_cuisine_traditional:4:a" to R.drawable.pl_05_oscypek,
        "tot:tot_polish_cuisine_traditional:4:b" to R.drawable.pl_05_kwasnica,
        "tot:tot_polish_cuisine_traditional:5:a" to R.drawable.pl_06_rosol,
        "tot:tot_polish_cuisine_traditional:5:b" to R.drawable.pl_06_flaki,
        "tot:tot_polish_cuisine_traditional:6:a" to R.drawable.pl_07_zapiekanka_krakowska,
        "tot:tot_polish_cuisine_traditional:6:b" to R.drawable.pl_07_obwarzanek_krakowski,
        "tot:tot_polish_cuisine_traditional:7:a" to R.drawable.pl_08_kluski_slaskie,
        "tot:tot_polish_cuisine_traditional:7:b" to R.drawable.pl_08_pyzy,
        "tot:tot_polish_cuisine_traditional:8:a" to R.drawable.pl_09_kaszanka,
        "tot:tot_polish_cuisine_traditional:8:b" to R.drawable.pl_09_golonka,
        "tot:tot_polish_cuisine_traditional:9:a" to R.drawable.pl_10_sledz_w_oleju,
        "tot:tot_polish_cuisine_traditional:9:b" to R.drawable.pl_10_pstrag_po_goralsku,
        "tot:tot_polish_cuisine_traditional:10:a" to R.drawable.pl_11_fasolka_po_bretonsku,
        "tot:tot_polish_cuisine_traditional:10:b" to R.drawable.pl_11_kapusta_z_grochem,
        "tot:tot_polish_cuisine_traditional:11:a" to R.drawable.pl_12_sernik_krakowski,
        "tot:tot_polish_cuisine_traditional:11:b" to R.drawable.pl_12_makowiec,
        "tot:tot_polish_cuisine_traditional:12:a" to R.drawable.pl_13_paczki,
        "tot:tot_polish_cuisine_traditional:12:b" to R.drawable.pl_13_faworki,
        "tot:tot_polish_cuisine_traditional:13:a" to R.drawable.pl_14_babka_piaskowa,
        "tot:tot_polish_cuisine_traditional:13:b" to R.drawable.pl_14_piernik_torunski,
        "tot:tot_polish_cuisine_traditional:14:a" to R.drawable.pl_15_szarlotka,
        "tot:tot_polish_cuisine_traditional:14:b" to R.drawable.pl_15_kremowka_papieska,
    )
